...
\begin{frame}{Type Inference - phase 1}
\begin{itemize}
...
\begin{frame}{Unfication - phase 2}
\begin{itemize}
...
\begin{frame}{Type Checking - phase 3}
\begin{itemize}
...
\begin{itemize}
\item Soundness - if we can infer the type of an expression, then we can type check
\end{itemize}
...
\end{itemize}
We want OutsideIn to be sound. And it is.

Completeness would be nice, too. But it isn't.
\end{frame}
