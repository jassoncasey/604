...
\begin{prooftree}
\def \fCenter{\ \vdash\ }
\AxiomC{$\Gamma \vdash \mbox{case T1}... : \tau \rightsquigarrow  C$}
...
\TrinaryInfC{$\mathcal{Q};\Gamma \vdash \mbox{ isT1} = \mbox{case T1 3 of } \{ \mbox{ T1 } n \rightarrow \mbox{ True }; \mbox{ T2 } \rightarrow \mbox{ False } \}, prog$}
\end{prooftree}
