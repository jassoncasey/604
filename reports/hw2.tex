...
This implementation supports both an interactive and compilation mode. Evaluator testing 
was primarily carried out using the interactive-mode of the SPL parser.
